...
// r_organization_admin lists the pages the person administers so the connect
// flow can offer them; w_organization_social is what posts as the page. Both
// come from the Community Management API product.
//
...
const SCOPES = process.env.LINKEDIN_SCOPES || "r_organization_admin w_organization_social";
