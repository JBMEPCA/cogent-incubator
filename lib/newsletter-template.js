...
export function renderLead(s) {
  return `
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
  <tr>
    <td style="padding:0 0 18px 0;">
      <a href="${esc(s.link)}" style="text-decoration:none;display:block;">
  ...
  <tr>
    <td style="padding:0 0 10px 0;">
      <a href="${esc(s.link)}" style="text-decoration:none;color:${BRAND.ink};">
  ...
  <tr>
    <td>
      <a href="${esc(s.link)}" style="text-decoration:none;font-family:${SANS};font-size:15px;font-weight:700;color:${BRAND.brand};">Read the full story &rsaquo;</a>
    </td>
  </tr>
</table>`;
}
...
export function renderSections(stories) {
  if (stories.length !== 10) throw new Error(`Need exactly 10 stories, got ${stories.length}`);
  const [lead, ...rest] = stories;
  const sections = { lead: renderLead(lead) };
  rest.forEach((s, i) => (sections[`story${i + 2}`] = renderRow(s)));
  return sections;
}

// ---- the shell (fixed forever) ----

export function renderShell({ issueDate, logoUrl }) {
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        <tr>
          <td align="center" style="padding:30px 24px 22px 24px;">
            <a href="https://smartsme.co.uk" style="text-decoration:none;display:inline-block;">
              <img src="${esc(logoUrl)}" width="190" alt="Smart SME"
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        ...
        <tr>
          <td align="center" style="font-family:${SANS};font-size:14px;line-height:1.55;color:${BRAND.muted};">
            Practical AI, finance and operations guidance for UK small businesses.
          </td>
        </tr>
        ${spacer(34)}
        <tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="border-collapse:separate;">
              <tr>
                <td align="center" bgcolor="${BRAND.brand}" style="border-radius:8px;padding:15px 34px;mso-padding-alt:15px 34px;">
                  <a href="https://smartsme.co.uk" style="display:block;font-family:${SANS};font-size:15px;font-weight:700;line-height:1;color:${BRAND.white};text-decoration:none;white-space:nowrap;">Visit Smart SME</a>
                </td>
              </tr>
            </table>
          </td>
  ...
  <tr>
    <td class="ss-pad" style="padding:40px 32px 42px 32px;background-color:${BRAND.ink};border-radius:0 0 12px 12px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        ...
        <tr>
          <td style="padding:0;font-family:${SANS};font-size:12px;line-height:1.8;color:${BRAND.mutedLight};">
            <a href="https://smartsme.co.uk/privacy-policy/" style="color:${BRAND.mutedLight};text-decoration:none;">Privacy policy</a>
            &nbsp;&nbsp;&#183;&nbsp;&nbsp;
            <a href="https://smartsme.co.uk/editorial-standards/" style="color:${BRAND.mutedLight};text-decoration:none;">Editorial standards</a>
            &nbsp;&nbsp;&#183;&nbsp;&nbsp;
            <a href="https://smartsme.co.uk/contact/" style="color:${BRAND.mutedLight};text-decoration:none;">Contact</a>
          </td>
        </tr>
        ${spacer(30)}
        <tr>
