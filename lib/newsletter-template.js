...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
  ...
  <tr><td style="padding:0 0 8px 0;">${kicker(s.category, t)}</td></tr>
  <tr>
    <td style="padding:0 0 10px 0;">
      <a href="${href}" style="text-decoration:none;color:${t.ink};">
        <span class="ss-lead-h" style="font-family:${t.sans};font-size:27px;line-height:1.2;font-weight:700;letter-spacing:-0.02em;color:${t.ink};">${clean(s.title)}</span>
      </a>
    </td>
  </tr>
  <tr>
    <td style="padding:0 0 16px 0;font-family:${t.sans};font-size:16px;line-height:1.55;color:${t.muted};">${clean(s.excerpt)}</td>
  </tr>
  <tr>
    <td>
      <a href="${href}" style="text-decoration:none;font-family:${t.sans};font-size:15px;font-weight:700;color:${t.brand};">Read the full story &rsaquo;</a>
    </td>
  </tr>
</table>`;
}
...
export function renderSections(stories, { campaign, site } = {}) {
  ...
  rest.forEach((s, i) => {
    ...
    sections[slot] = renderRow(s, { campaign, slot, theme: t });
  });
  return sections;
}
...
export function renderShell({ site, issueDate, logoUrl, logoWidth = 190, campaign }) {
  ...
  const rows = Array.from({ length: 9 }, (_, i) => {
    ...
    return `
      <tr>
        <td style="padding:20px 0;border-top:1px solid ${t.line};">
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
            <tr>${slot(key)}</tr>
          </table>
        </td>
...
<table role="presentation" class="ss-wrap" cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;max-width:600px;border-collapse:collapse;">
  ...
  <tr>
    <td align="center" style="padding:0;background-color:${t.white};border-radius:12px 12px 0 0;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        ...
        <tr><td style="padding:0;font-size:0;line-height:0;background-color:${t.brand};height:3px;">&nbsp;</td></tr>
        <tr>
          <td align="center" style="padding:14px 24px 0 24px;font-family:${t.sans};font-size:11px;font-weight:500;letter-spacing:0.14em;text-transform:uppercase;color:${t.mutedLight};">
  ...
  <tr>
    <td class="ss-pad" style="padding:26px 32px 22px 32px;background-color:${t.white};">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        <tr>${slot("lead")}</tr>
      </table>
    </td>
  ...
  <tr>
    <td class="ss-pad" style="padding:6px 32px 0 32px;background-color:${t.white};">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        <tr>
          <td style="padding:4px 0 0 0;font-family:${t.sans};font-size:12px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:${t.ink};">
            More this week
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td class="ss-pad" style="padding:8px 32px 26px 32px;background-color:${t.white};">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
${rows}
      </table>
    </td>
