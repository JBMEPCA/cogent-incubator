...
export function renderShell({ site, issueDate, logoUrl }) {
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="border-collapse:separate;">
              <tr>
                <td align="center" bgcolor="${BRAND.brand}" style="border-radius:8px;padding:15px 34px;mso-padding-alt:15px 34px;">
                  <a href="${HOME}" style="display:block;font-family:${SANS};font-size:15px;font-weight:700;line-height:1;color:${BRAND.white};text-decoration:none;white-space:nowrap;">Visit ${esc(NAME)}</a>
                </td>
              </tr>
            </table>
          </td>
  ...
  <tr>
    <td class="ss-pad" style="padding:40px 32px 42px 32px;background-color:${BRAND.ink};border-radius:0 0 12px 12px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;">
        ...
        <tr>
          <td style="padding:0;font-family:${SANS};font-size:12px;line-height:1.8;color:${BRAND.mutedLight};">
            <a href="${HOME}/privacy-policy/" style="color:${BRAND.mutedLight};text-decoration:none;">Privacy policy</a>
            &nbsp;&nbsp;&#183;&nbsp;&nbsp;
            <a href="${HOME}/editorial-standards/" style="color:${BRAND.mutedLight};text-decoration:none;">Editorial standards</a>
            &nbsp;&nbsp;&#183;&nbsp;&nbsp;
            <a href="${HOME}/contact/" style="color:${BRAND.mutedLight};text-decoration:none;">Contact</a>
          </td>
        </tr>
        ${spacer(30)}
        <tr>
