...
//
// CONVERSION STATUS: the to-do actions below follow this pattern. The CRM, PR
// brand, advertiser, content, SEO, LinkedIn and outreach blocks further down
// still have their original single-tenant signatures and will throw when
// called, because the scoped Prisma client refuses an unscoped query. They are
// mechanical to convert and follow exactly the shape shown here.
