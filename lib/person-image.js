...
/** The app's public address, for the card route. */
export function appUrl() {
  return String(process.env.APP_URL || "https://cogent-incubator.vercel.app").replace(/\/$/, "");
}
...
export async function pictureForPerson(site, { title, body, sourceUrl, subject = null, upload = null }) {
  ...
  if (s.kind !== "person" || !s.name) return { subject: s, image: null };
